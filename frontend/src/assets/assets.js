...
export const faqs = [
  {
    ...
    description1:
      "By accessing and using the Hirenest Job Portal, you agree to comply with these Terms of Service. The platform is intended for employers seeking to post job opportunities and candidates applying for jobs. Any misuse, such as posting misleading information or fraudulent job listings, is strictly prohibited.",
    description2:
      "Users are responsible for maintaining the confidentiality of their account credentials. Hirenest reserves the right to suspend or terminate accounts found to be in violation of these terms without prior notice.",
  },
  {
    id: 2,
    title: "Limitations of Use",
    description1:
      "You may not use the Hirenest platform in any way that could damage, disable, or impair our services. Employers must ensure that all job postings comply with applicable labor laws and do not contain discriminatory, offensive, or misleading content.",
    description2:
      "Candidates are expected to provide accurate information in their resumes and applications. Submitting false qualifications, plagiarized content, or impersonating another individual will result in immediate account suspension.",
  },
  {
    id: 3,
    title: "Revisions and Updates",
    description1:
      "Hirenest may update these Terms and Conditions at any time to reflect changes in our services, policies, or legal requirements. Continued use of the platform after such revisions constitutes acceptance of the updated terms.",
    description2:
      "We encourage users to review this page regularly to stay informed about any modifications. Significant changes will be communicated via email or platform notifications.",
  },
  {
    id: 4,
    title: "Site Usage & Modifications",
    description1:
      "Hirenest reserves the right to modify, suspend, or discontinue any part of the platform at its discretion, with or without prior notice. We are not liable for any temporary downtime, loss of data, or interruptions in service.",
    description2:
      "While we strive to ensure a secure and reliable platform, Hirenest cannot guarantee uninterrupted access. Users agree that Hirenest shall not be held responsible for any damages resulting from such modifications or service disruptions.",
  },
];
